...
$user_id = $_REQUEST['id']; //string　文字列型で取得　←echo gettype($user);を実行して文字列型で取得していることが確認できた。が、文字列$userになっていた
// echo '<br />';
// var_dump($user_id);
// echo gettype($user);
...
if (isset($_GET['m'])) {
    ...
    $yyyymm = $_GET['m'];
    $day_cont = date('t', strtotime($yyyymm));
} else {
...
$sql = "SELECT date,start_mater,start_time,end_mater,end_time,hour_mater_start,hour_mater_end,break_time,client,project_name,comment FROM work where user_id=:user_id AND DATE_FORMAT(date,'%Y-%m')=:date";
$stmt = $pdo->prepare($sql);
...
// userテーブルのidを検索し、$_REQUEST['id]に一致するuserのuser_screen_nameを返す
$stmt = $pdo->prepare("SELECT user_screen_name FROM user WHERE id = ?");
$stmt->execute([$_REQUEST['id']]);
$user_screen_name = $stmt->fetchColumn();
...
<body>
    ...
    <body class="text-center mt-5 bg-info">
        <div class="container">
            <img class="d-block mx-auto mb-4" src="../img/nippou.svg" alt="" width="100" height="100" loading="lazy">

            <body id="main bg-info">
                <form class="border rounded bg-light form-time-table py-5 px-3">
                    <h3 class="h4 my-3">月別リスト</h3>
                    <div class="card">
                        <div class="row mt-5">
                            <div class="col-3 my-3 mt-3 mx-4">
                            ...
                            <div class="col-3 my-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" value="<?php echo $user_screen_name; ?> ">
                        ...
                        <div class="row mx-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="col-2">
                                    <select class="form-select rounded-pill" name="m" onchange="submit(this.form)">
                                ...
                                <tbody>
                                    <?php for ($i = 1; $i <= $day_count; $i++) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $project_name ?></td>
                                            <td><?= $comment ?></td>
                                            <td><button type="button" class="btn btn-default h-auto py-0" data-bs-toggle="modal" data-bs-target="#inputModal" data-day="<?= $yyyymm . '-' . sprintf('%02d', $i) ?>"><i class="fa-solid fa-pencil"></i></button></td>
                            ...
                            <div class="modal-body">
                                <div class="container text-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="出庫" id="modal_start_time" name="modal_start_time" value="<?= format_time($modal_start_time) ?>">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="入庫" id="modal_end_time" name="modal_end_time" value="<?= format_time($modal_end_time) ?>">
