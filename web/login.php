        ...
        if (empty($err)) {
            ...
            if (!$user) {
                ...
                if (empty($err)) {
                    ...
                    //4.ログイン処理（セッションに保存）
                    if ($user) {
                        $_SESSION['USER'] = $user; //←array 配列型で取得　echo gettype($user)；を実行してarray配列型で取得していることが確認できた
                        //var_dump($user);
                        //echo gettype($user);
                        //echo 'CHECK POINT1<br />';
                                ...
                                <form class="needs-validation row g-3" novalidate>
                                    <div class="col-12 bg-light">
                                        <div class="p-2">
                                            ...
                                            <span class="glyphicon form-control-feedback glyphicon-remove text-danger" aria-hidden="true"><?= $err['user_no']; ?></span>

                                        </div>
                                        <div class="col-12 bg-light">
                                            <div class="p-2">
                                                <label class=float-start>生年月日</label>
                                                <input type="date" name="user_birthday" class="form-control rounded-pill" min="1000-10-20" value="<?= $user_birthday; ?>" required>
                                                <span class="glyphicon form-control-feedback glyphicon-remove text-danger" aria-hidden="true"><?= $err['user_birthday']; ?></span>
                                            </div>
                                        ...
                                        <div class="col-12 bg-light">
                                            <div class="p-2">
                                                ...
                                                <span class="glyphicon form-control-feedback glyphicon-remove text-danger" aria-hidden="true"><?= $err['user_password']; ?></span>
                                            </div>
                                        ...
                                        <div class="col-12 p-1">
                                            <div class="form-check">
                                                <input name="auto_login" class="form-check-input" type="checkbox" value="1" id="defaultCheck2">
                                    ...
                                    <div class="mt-3">
                                        <a href="signup.php"><input type="button" class="btn btn-success text-white rounded-pill" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: 1.0rem; --bs-btn-font-size: 1.00rem;" value="新規ユーザー登録"></a>
                                    </div>
                                    <div class="mt-3">
                                        <input type="submit" class="btn btn-primary rounded-pill" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: 2.80rem; --bs-btn-font-size: 1.00rem;" value="ログイン">
                                    </div>
                                    <div class="position-relative">
                                        <div class="mt-3">
                                            <a href="admin/login.php"><input type="button" class="btn btn-secondary rounded-pill" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: 1.5rem; --bs-btn-font-size: 1.00rem;" value="管理者ログイン"></a>
                                        </div>
                                        <div class="position-absolute bottom-0 end-0 mt-3">
                                            <a href="password_reset.php"><input type="button" class="btn btn-danger" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: 1.5rem; --bs-btn-font-size: 0.85rem;" value="パスワードを忘れた"></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
